...
const Card4 = () => {
  ...
  const getData = () => {
    ...
    fetch(`https://newsapi.org/v2/everything?domains=wsj.com&apiKey=a51462388d244472843a2005c9253ed0&pageSize=${pageSize}`)
      .then(response => {
        if (!response.ok) {
      ...
      {data.articles.map((article, index) => (
        <div className="card-trans">
            ...
            <div className="card-article-wrapper">
              <div className="article-categories">Finance</div>
